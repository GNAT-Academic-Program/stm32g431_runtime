...
with Interfaces.STM32.SCB;
with Interfaces.STM32.STK;
with Interfaces.STM32.NVIC;

package body System.BB.Board_Support is
   procedure Setup_Board;
   pragma Import (C, Setup_Board, "_ada_setup_board");
   pragma Unreferenced (Setup_Board);
   ...
   ICSR : Word with Volatile,
      Address => Interfaces.STM32.SCB.SCB_Periph.ICSR'Address;
   ...
   SYST : Sys_Tick_Registers with Volatile,
      Address => Interfaces.STM32.STK.STK_Periph'Address;
   ...
   NVIC_ISER : array (0 .. 15) of Word with
     Volatile,
     Address => Interfaces.STM32.NVIC.NVIC_Periph'Address;
   ...
   IP : array (0 .. Interrupt_ID'Last) of NVIC_Priority with
     Volatile,
     Address => Interfaces.STM32.NVIC.NVIC_Periph.IPR0'Address;
