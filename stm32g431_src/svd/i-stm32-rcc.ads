...
package Interfaces.STM32.RCC is
   ...
   subtype CR_PLLSYSON_Field is Interfaces.STM32.Bit;
   subtype CR_PLLSYSRDY_Field is Interfaces.STM32.Bit;
   ...
   type CR_Register is record
      ...
      --  Main PLL enable
      PLLSYSON       : CR_PLLSYSON_Field := 16#0#;
      --  Read-only. Main PLL clock ready flag
      PLLSYSRDY      : CR_PLLSYSRDY_Field := 16#0#;
      --  unspecified
   ...
   for CR_Register use record
      ...
      PLLSYSON       at 0 range 24 .. 24;
      PLLSYSRDY      at 0 range 25 .. 25;
   ...
   subtype PLLSYSCFGR_PLLSYSM_Field is Interfaces.STM32.UInt4;
   subtype PLLSYSCFGR_PLLSYSN_Field is Interfaces.STM32.UInt7;
   subtype PLLSYSCFGR_PLLPEN_Field is Interfaces.STM32.Bit;
   subtype PLLSYSCFGR_PLLSYSP_Field is Interfaces.STM32.Bit;
   subtype PLLSYSCFGR_PLLSYSQEN_Field is Interfaces.STM32.Bit;
   subtype PLLSYSCFGR_PLLSYSQ_Field is Interfaces.STM32.UInt2;
   subtype PLLSYSCFGR_PLLSYSREN_Field is Interfaces.STM32.Bit;
   subtype PLLSYSCFGR_PLLSYSR_Field is Interfaces.STM32.UInt2;
   subtype PLLSYSCFGR_PLLSYSPDIV_Field is Interfaces.STM32.UInt5;
   ...
   type PLLSYSCFGR_Register is record
      ...
      --  input clock
      PLLSYSM        : PLLSYSCFGR_PLLSYSM_Field := 16#0#;
      --  Main PLL multiplication factor for VCO
      PLLSYSN        : PLLSYSCFGR_PLLSYSN_Field := 16#10#;
      --  unspecified
   ...
   for PLLSYSCFGR_Register use record
      ...
      PLLSYSM        at 0 range 4 .. 7;
      PLLSYSN        at 0 range 8 .. 14;
      Reserved_15_15 at 0 range 15 .. 15;
      PLLPEN         at 0 range 16 .. 16;
      PLLSYSP        at 0 range 17 .. 17;
      Reserved_18_19 at 0 range 18 .. 19;
      PLLSYSQEN      at 0 range 20 .. 20;
      PLLSYSQ        at 0 range 21 .. 22;
      Reserved_23_23 at 0 range 23 .. 23;
      PLLSYSREN      at 0 range 24 .. 24;
      PLLSYSR        at 0 range 25 .. 26;
      PLLSYSPDIV     at 0 range 27 .. 31;
   end record;
   ...
   subtype AHB1RSTR_MATRIXRST_Field is Interfaces.STM32.Bit;
   subtype AHB1RSTR_FLITFRST_Field is Interfaces.STM32.Bit;
   ...
   type AHB1RSTR_Register is record
      ...
      --  MATRIX reset
      MATRIXRST      : AHB1RSTR_MATRIXRST_Field := 16#0#;
      --  unspecified
      Reserved_5_7   : Interfaces.STM32.UInt3 := 16#0#;
      --  FLITF reset
      FLITFRST       : AHB1RSTR_FLITFRST_Field := 16#0#;
      --  unspecified
   ...
   for AHB1RSTR_Register use record
      ...
      MATRIXRST      at 0 range 4 .. 4;
      Reserved_5_7   at 0 range 5 .. 7;
      FLITFRST       at 0 range 8 .. 8;
   ...
   subtype AHB3RSTR_QUADSPI1RST_Field is Interfaces.STM32.Bit;
   ...
   type AHB3RSTR_Register is record
      ...
      QUADSPI1RST   : AHB3RSTR_QUADSPI1RST_Field := 16#0#;
      --  unspecified
   ...
   subtype APB1RSTR1_I2C3_Field is Interfaces.STM32.Bit;
   ...
   type APB1RSTR1_Register is record
      ...
      I2C3           : APB1RSTR1_I2C3_Field := 16#0#;
   ...
   --  AHB2ENR_DAC array element
   subtype AHB2ENR_DAC_Element is Interfaces.STM32.Bit;

   --  AHB2ENR_DAC array
   type AHB2ENR_DAC_Field_Array is array (1 .. 4) of AHB2ENR_DAC_Element
     with Component_Size => 1, Size => 4;

   --  Type definition for AHB2ENR_DAC
   type AHB2ENR_DAC_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  DAC as an array
            Arr : AHB2ENR_DAC_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 4;

   for AHB2ENR_DAC_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;
   ...
   type AHB2ENR_Register is record
      ...
      DAC            : AHB2ENR_DAC_Field := (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_20_23 : Interfaces.STM32.UInt4 := 16#0#;
   ...
   subtype AHB3ENR_QUADSPI1EN_Field is Interfaces.STM32.Bit;
   ...
   type AHB3ENR_Register is record
      ...
      QUADSPI1EN    : AHB3ENR_QUADSPI1EN_Field := 16#0#;
      --  unspecified
      Reserved_9_31 : Interfaces.STM32.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype APB1ENR1_SP3EN_Field is Interfaces.STM32.Bit;
   ...
   subtype APB1ENR1_I2C3_Field is Interfaces.STM32.Bit;
   ...
   subtype APB2ENR_HRTIMEREN_Field is Interfaces.STM32.Bit;
   ...
   type APB2ENR_Register is record
      ...
      HRTIMEREN      : APB2ENR_HRTIMEREN_Field := 16#0#;
      --  unspecified
      Reserved_27_31 : Interfaces.STM32.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype AHB3SMENR_QUADSPI1SMEN_Field is Interfaces.STM32.Bit;
   ...
   type AHB3SMENR_Register is record
      ...
      QUADSPI1SMEN  : AHB3SMENR_QUADSPI1SMEN_Field := 16#1#;
      --  unspecified
      Reserved_9_31 : Interfaces.STM32.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype CCIPR1_USART1SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_USART2SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_USART3SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_UART4SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_UART5SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_LPUART1SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_I2C1SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_I2C2SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_I2C3SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_LPTIM1SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_SAISEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_SPISEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_FDCANSEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_CLK48SEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_ADCSEL_Field is Interfaces.STM32.UInt2;
   subtype CCIPR1_ADC345SEL_Field is Interfaces.STM32.UInt2;
   ...
   for CCIPR1_Register use record
      ...
      SAISEL     at 0 range 20 .. 21;
      SPISEL     at 0 range 22 .. 23;
   ...
   subtype CCIPR2_QUADSPISEL_Field is Interfaces.STM32.UInt2;
   ...
   type CCIPR2_Register is record
      ...
      QUADSPISEL     : CCIPR2_QUADSPISEL_Field := 16#0#;
      --  unspecified
