# This script takes the stm32g431 runtimes generated by build-rts.py and
...
#  - adds stm32g431_runtime_config.ads which renames the crate config package
...
def patch_target_options(gpr_file: pathlib.Path, profile: str, target: str):
    ...
    E.g. for light-tasking-stm32g431:
    BUILD becomes LIGHT_TASKING_STM32G431_BUILD
    LIBRARY_TYPE becomes LIGHT_TASKING_STM32G431_LIBRARY_TYPE
...
def main():
    ...
    parser.add_argument(
        "--pretty-target",
        type=str,
        help="The pretty name of the target (e.g. stm32g431). Must not contain spaces",
    )
    parser.add_argument(
        "--version",
        type=str,
    ...
    gen_from_template(
        template_file=templates_dir / "stm32g431_runtime_config.ads.in",
        out_file=runtime_dir / "gnat_user" / "stm32g431_runtime_config.ads",
        template_values=template_values,
    )
