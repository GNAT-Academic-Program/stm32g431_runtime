...
package Interfaces.STM32.OPAMP is
   ...
   subtype OPAMP1_CSR_OPAHSM_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_CSR_OPAINTOEN_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_CSR_CALON_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_CSR_CALSEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP1_CSR_PGA_GAIN_Field is Interfaces.STM32.UInt5;
   ...
   type OPAMP1_CSR_Register is record
      ...
      --  OPAINTOEN
      OPAINTOEN      : OPAMP1_CSR_OPAINTOEN_Field := 16#0#;
      --  unspecified
   ...
   subtype OPAMP2_CSR_OPAHSM_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_CSR_OPAINTOEN_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_CSR_CALON_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_CSR_CALSEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP2_CSR_PGA_GAIN_Field is Interfaces.STM32.UInt5;
   ...
   type OPAMP2_CSR_Register is record
      ...
      --  OPAINTOEN
      OPAINTOEN      : OPAMP2_CSR_OPAINTOEN_Field := 16#0#;
      --  unspecified
      Reserved_9_10  : Interfaces.STM32.UInt2 := 16#0#;
      --  CALON
   ...
   subtype OPAMP3_CSR_OPAEN_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_CSR_FORCE_VP_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_CSR_VP_SEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP3_CSR_USERTRIM_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_CSR_VM_SEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP3_CSR_OPAHSM_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_CSR_OPAINTOEN_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_CSR_CALON_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_CSR_CALSEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP3_CSR_PGA_GAIN_Field is Interfaces.STM32.UInt5;
   ...
   type OPAMP3_CSR_Register is record
      ...
      Reserved_29_29 : Interfaces.STM32.Bit := 16#0#;
      --  CALOUT
      CALOUT         : OPAMP3_CSR_CALOUT_Field := 16#0#;
      --  LOCK
   ...
   subtype OPAMP1_TCMR_VMS_SEL_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_TCMR_VPS_SEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP1_TCMR_T1CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_TCMR_T8CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_TCMR_T20CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP1_TCMR_LOCK_Field is Interfaces.STM32.Bit;

   --  OPAMP1 control/status register
   type OPAMP1_TCMR_Register is record
      --  VMS_SEL
      VMS_SEL       : OPAMP1_TCMR_VMS_SEL_Field := 16#0#;
      --  VPS_SEL
      VPS_SEL       : OPAMP1_TCMR_VPS_SEL_Field := 16#0#;
      --  T1CM_EN
      T1CM_EN       : OPAMP1_TCMR_T1CM_EN_Field := 16#0#;
      --  T8CM_EN
      T8CM_EN       : OPAMP1_TCMR_T8CM_EN_Field := 16#0#;
      --  T20CM_EN
      T20CM_EN      : OPAMP1_TCMR_T20CM_EN_Field := 16#0#;
      --  unspecified
      Reserved_6_30 : Interfaces.STM32.UInt25 := 16#0#;
      --  LOCK
      LOCK          : OPAMP1_TCMR_LOCK_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OPAMP2_TCMR_VMS_SEL_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_TCMR_VPS_SEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP2_TCMR_T1CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_TCMR_T8CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_TCMR_T20CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP2_TCMR_LOCK_Field is Interfaces.STM32.Bit;

   --  OPAMP2 control/status register
   type OPAMP2_TCMR_Register is record
      --  VMS_SEL
      VMS_SEL       : OPAMP2_TCMR_VMS_SEL_Field := 16#0#;
      --  VPS_SEL
      VPS_SEL       : OPAMP2_TCMR_VPS_SEL_Field := 16#0#;
      --  T1CM_EN
      T1CM_EN       : OPAMP2_TCMR_T1CM_EN_Field := 16#0#;
      --  T8CM_EN
      T8CM_EN       : OPAMP2_TCMR_T8CM_EN_Field := 16#0#;
      --  T20CM_EN
      T20CM_EN      : OPAMP2_TCMR_T20CM_EN_Field := 16#0#;
      --  unspecified
      Reserved_6_30 : Interfaces.STM32.UInt25 := 16#0#;
      --  LOCK
      LOCK          : OPAMP2_TCMR_LOCK_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OPAMP3_TCMR_VMS_SEL_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_TCMR_VPS_SEL_Field is Interfaces.STM32.UInt2;
   subtype OPAMP3_TCMR_T1CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_TCMR_T8CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_TCMR_T20CM_EN_Field is Interfaces.STM32.Bit;
   subtype OPAMP3_TCMR_LOCK_Field is Interfaces.STM32.Bit;

   --  OPAMP3 control/status register
   type OPAMP3_TCMR_Register is record
      --  VMS_SEL
      VMS_SEL       : OPAMP3_TCMR_VMS_SEL_Field := 16#0#;
      --  VPS_SEL
      VPS_SEL       : OPAMP3_TCMR_VPS_SEL_Field := 16#0#;
      --  T1CM_EN
      T1CM_EN       : OPAMP3_TCMR_T1CM_EN_Field := 16#0#;
      --  T8CM_EN
      T8CM_EN       : OPAMP3_TCMR_T8CM_EN_Field := 16#0#;
      --  T20CM_EN
      T20CM_EN      : OPAMP3_TCMR_T20CM_EN_Field := 16#0#;
      --  unspecified
      Reserved_6_30 : Interfaces.STM32.UInt25 := 16#0#;
      --  LOCK
      LOCK          : OPAMP3_TCMR_LOCK_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
